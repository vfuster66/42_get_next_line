...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/10 16:53:09 by vfuster-          #+#    #+#             */
/*   Updated: 2023/02/17 07:37:37 by vfuster-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*****************************************************************************
 *
 * Permet de lire une ligne a la fois a partir d'un file descriptor en 
 * utilisant un buffer BUFFER_SIZE pour stocker les donnees lues.
 * Donnees concatenees avec join_strs. La boucle se poursuit jusqu'a ce
 * qu'une ligne soit lue.
 * ft_parse_line appelee pour extraire la ligne a partir de keep.
 * Verifie que la ligne n'est pas vide et libere la memoire allouee avant
 * de retourner la ligne lue.
 * Si ligne vide -> memoire liberee et retourne NULL.
 *
 * **************************************************************************/
